            ...
            <div className={styles.subfooter}>
                ...
                <div className={styles.right_side}>
                    ...
                    <div className={styles.input_area}>
                        ...
                        <button className='btn btn2'>Get notified</button>
                    </div>
                </div>
            </div>
            <div className="container">
                <a className={styles.logo} href="it-tanlov.uz">IT-Tanlov.uz</a>
                <p className={styles.announcement}>Yoshlar o‘rtasida IT ta’limni keng targ‘ib qilishda faol kontent mualliflar <br /> o‘rtasida "Videoroliklar" tanlovini e’lon qilamiz!</p>
                ...
                <div className={styles.rights}>
                    ...
                    <span className={styles.privacy}> <a href="www.it-tanlov.uz">Privacy Policy</a> | <a href="www.it-tanlov.uz">Terms&Conditions</a></span>
                </div>
            </div>
        </footer>
    )
